...
function setUpPhong(program) {
    ...
    gl.uniform3fv(program.lightPosition, [0, 0, -1.5]);
    
    gl.uniform3fv(program.lightColor, [1, 1, 1]);

    gl.uniform3fv(program.baseColor, [1, 0, 0]);
...
function setUpCamera(program) {
    ...
    glMatrix.mat4.perspective(projMatrix, 1, 1, 1, 5);
    gl.uniformMatrix4fv (program.uProjT, false, projMatrix);
    
    // set up your view
    let viewMatrix = glMatrix.mat4.create();
    glMatrix.mat4.lookAt(viewMatrix, [0, 3, -3], [0, 0, 0], [0, 1, 0]);
